...
export default function BuildView({ setCurrentTab }: { setCurrentTab: (tab: string) => void }) {
  return (
    <div className="w-full flex flex-col bg-white">
      ...
      <section className="py-24 px-6 border-b border-[#E8E2D8]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:pr-16">
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            ...
            <ul className="space-y-4 text-sm text-slate-700 font-medium mb-10">
          ...
          <div className="w-full lg:w-1/2">
             <div className="bg-cream rounded-2xl p-10 h-full flex flex-col justify-center border border-[#E8E2D8]">
                <div className="grid grid-cols-2 gap-8 text-center sm:text-left">
                  <div>
                    ...
                    <div className="text-xs uppercase tracking-wider text-slate-500 font-mono">Addressable Customers</div>
                  </div>
                  <div>
                    <div className="text-3xl font-serif text-purple-deep font-bold mb-1">$4B</div>
                    <div className="text-xs uppercase tracking-wider text-slate-500 font-mono">Industry Size</div>
                  </div>
                  <div>
                    <div className="text-3xl font-serif text-purple-deep font-bold mb-1">110%</div>
                    <div className="text-xs uppercase tracking-wider text-slate-500 font-mono">YoY Growth</div>
                  </div>
                  <div>
                    <div className="text-3xl font-serif text-purple-deep font-bold mb-1">1–3%</div>
                    <div className="text-xs uppercase tracking-wider text-slate-500 font-mono">Commission</div>
                  </div>
                </div>
             </div>
          </div>
      ...
      {/* Track 2 - Merchants */}
      <section className="py-24 px-6 border-b border-[#E8E2D8] bg-[#FAFAFA]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row-reverse gap-16 lg:pl-16">
          ...
          <div className="w-full lg:w-1/2">
             <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-10 h-full flex flex-col border border-[#E8E2D8] items-center justify-center">
      ...
      <section className="py-20 px-6 text-center bg-cream">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button onClick={() => setCurrentTab("contact")} className="rounded-full bg-purple-deep px-8 py-3.5 text-sm font-bold text-white transition hover:bg-[#1E0A4E]/90 hover:scale-105">
            Get in touch &rarr;
          </button>
          <button onClick={() => setCurrentTab("advisor")} className="rounded-full border border-purple-deep px-8 py-3.5 text-sm font-bold text-purple-deep transition hover:bg-white hover:scale-105">
            Ask Umaiza &rarr;
          </button>
        </div>
      </section>
