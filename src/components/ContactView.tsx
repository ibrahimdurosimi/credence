  ...
  if (isSubmitted) {
    return (
      <div className="bg-cream text-purple-deep min-h-[600px] flex items-center justify-center px-6 py-20 animate-fade-in">
        <div className="bg-white border border-[#E8E2D8] rounded-3xl p-8 md:p-12 max-w-md w-full text-center shadow-xl">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white border border-[#E8E2D8] rounded-2xl p-6 flex items-start gap-4 hover:border-gold transition">
              <div className="p-3 bg-gold/15 rounded-xl text-gold">
                <Mail className="h-5 w-5" />
              </div>
              <div>
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Email Desk</span>
            ...
            <div className="bg-white border border-[#E8E2D8] rounded-2xl p-6 flex items-start gap-4 hover:border-gold transition">
              ...
              <div>
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Direct Phone</span>
            ...
            <div className="bg-white border border-[#E8E2D8] rounded-2xl p-6 flex items-start gap-4 hover:border-gold transition">
              ...
              <div>
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Direct Web</span>
            ...
            <div className="bg-white border border-[#E8E2D8] rounded-2xl p-6 flex items-start gap-4 hover:border-gold transition">
              ...
              <div>
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest font-bold">Locations</span>
          ...
          <form
            ...
            className="bg-white border border-[#E8E2D8] rounded-3xl p-8 lg:col-span-3 space-y-6 shadow-md"
          >
            <h2 className="font-serif text-2xl font-semibold text-purple-deep">Send a Direct Inquiry</h2>

            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider text-slate-500 font-mono">Your Name</label>
                <input
                  required
                  type="text"
                  value={formData.name}
                  onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                  className="w-full bg-white border border-[#E8E2D8] focus:border-gold rounded-xl px-4 py-3 text-sm focus:outline-none transition"
                  placeholder="e.g. Ibrahim"
                />
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider text-slate-500 font-mono">Mail Address</label>
                <input
                  required
                  type="email"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider text-slate-500 font-mono">Organization</label>
                <input
                  type="text"
                  value={formData.org}
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold uppercase tracking-wider text-slate-500 font-mono">I am a</label>
                <select
                  value={formData.type}
                  onChange={(e) => setFormData({ ...formData, type: e.target.value })}
                  className="w-full bg-white border border-[#E8E2D8] focus:border-gold rounded-xl px-4 py-3 text-sm focus:outline-none transition cursor-pointer"
                >
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-500 font-mono">Your Message</label>
              <textarea
                required
                rows={5}
